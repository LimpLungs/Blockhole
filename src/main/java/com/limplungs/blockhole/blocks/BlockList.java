...
public class BlockList 
{
	...
	//public static ItemBlockBasic ITEMBLOCK_TELEPORTER;
	public static ItemBlockBasic ITEMBLOCK_POWDERKEG;
	public static ItemBlockBasic ITEMBLOCK_BLOCKHOLE;
	public static ItemBlockBasic ITEMBLOCK_BLOCKHOLE_WALL;
	
	public static void registerItemBlocks()
	{
		//ITEMBLOCK_TELEPORTER = new ItemBlockBasic(TELEPORTER);
		ITEMBLOCK_POWDERKEG = new ItemBlockBasic(POWDERKEG);
		ITEMBLOCK_BLOCKHOLE = new ItemBlockBasic(BLOCKHOLE);
		ITEMBLOCK_BLOCKHOLE_WALL = new ItemBlockBasic(BLOCKHOLE_WALL);
	}
